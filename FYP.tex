...
\begin{tikzpicture}
\begin{axis}[
    title=Packet loss for varying lengths of mains-like cable.,
    ybar=3pt,
    ymin=0,
    width=\columnwidth,
...
\begin{tikzpicture}
\begin{axis}[
    title=Error detect \& correct rates for the hub in \%,
    ybar=3pt,
    ymin=0,
    ymax=105,
    width=\columnwidth,
...
\legend{100 pkts (65/20/10/5),100 pkts (30/40/20/10),100 pkts (0/50/30/20)}
\end{axis}
\end{tikzpicture}
...
\legend{500 pkts (325/100/50/25),500 pkts (150/200/100/50),500 pkts (0/250/150/100)}
\end{axis}
\end{tikzpicture}
...
\legend{1000 pkts (650/200/100/50),1000 pkts (300/400/200/100),1000 pkts (0/500/300/200)}
\end{axis}
\end{tikzpicture}
...
\paragraph{Proposed usability study}
